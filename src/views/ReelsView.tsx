...
export const ReelsView: React.FC = () => {
  ...
  const fetchReels = async () => {
    ...
    loadedReels.forEach((reel, idx) => {
      initialLikes[reel.id] = reel.likesCount || 120 + idx * 45;
      initialComments[reel.id] = [
        {
          id: `c-1-${reel.id}`,
          authorName: 'Fr. Markos',
          authorAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200',
          text: 'Glory be to God! Truly inspiring chant.',
          createdAt: '2h ago',
        },
        {
          id: `c-2-${reel.id}`,
          ...
          text: 'Blessed feast day to all brethren! 🙏',
          createdAt: '45m ago',
        },
      ];
    });
              ...
              <div className="relative z-20 p-4 bg-gradient-to-t from-black/95 via-black/60 to-transparent space-y-2 mt-auto">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    />
                    <button
                      onClick={() => handleToggleFollow(reel.authorName)}
