...
import { getJoinedGroupIds, toggleGroupJoin } from '../utils/groups';
...
const ALL_MEMBERS: ParishMember[] = [
  {
    id: 'm1',
    name: 'Fr. Seraphim Rose',
    title: 'Hieromonk & Author',
    parish: 'St. Herman Monastery',
    avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=200',
    bio: 'Serving the monastic rule, Orthodox publishing, and spiritual fatherhood.',
    isOnline: true,
  },
  {
    id: 'm2',
    name: 'Eleni Chrysostom',
    title: 'Protopsaltria & Choir Director',
    parish: 'Holy Trinity Cathedral',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=200',
    bio: 'Dedicated to preserving traditional Byzantine chant and choral harmony.',
    isOnline: true,
  },
  {
    id: 'm3',
    name: 'Deacon Markos Haddad',
    title: 'Archdeacon & Youth Leader',
    parish: 'St. George Antiochian',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200',
    bio: 'Organizing youth pilgrimages and Coptic iconography workshops.',
    isOnline: false,
  },
  {
    id: 'm4',
    ...
    bio: 'Coordinating parish philanthropy and St. Elizabeth women ministry.',
    isOnline: true,
  },
  {
    id: 'm5',
    name: 'Subdeacon Peter',
    title: 'Catechist & Reader',
    parish: 'St. Mark Coptic Cathedral',
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200',
    bio: 'Teaching Sunday School and translating Patristic texts.',
    isOnline: false,
  },
  {
    id: 'm6',
    name: 'Maria Theotokis',
    title: 'Parish Iconographer',
    parish: 'Holy Resurrection Parish',
    avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=200',
    bio: 'Restoring egg-tempera icons and sanctuary frescoes.',
    isOnline: true,
  },
];
...
const ALL_GROUPS: GroupRoom[] = [
  ...
  },
  {
    ...
    activeCount: 15,
    icon: '🌹',
    hostName: 'Anna Papadopoulos',
    parish: 'St. Nicholas Church',
  },
];

export const GroupRoomsView: React.FC = () => {
  const { t } = useTheme();
  ...
  const followedMembersList = ALL_MEMBERS.filter((m) =>
    followedNames.some((fn) => fn.toLowerCase() === m.name.toLowerCase())
  );

  const nonFollowedMembersList = ALL_MEMBERS.filter(
    (m) => !followedNames.some((fn) => fn.toLowerCase() === m.name.toLowerCase())
  );

  const joinedGroupsList = ALL_GROUPS.filter((g) => joinedGroupIds.includes(g.id));
  const otherGroupsList = ALL_GROUPS.filter((g) => !joinedGroupIds.includes(g.id));
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1">
                        <h4 className="font-serif-coptic font-bold text-sm text-[#3d2b18] dark:text-[#f5ebd9] uppercase tracking-wider truncate">
                          {member.name}
                        </h4>
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <h4 className="font-serif-coptic font-bold text-xs text-[#3d2b18] dark:text-[#f5ebd9] uppercase tracking-wider truncate">
                          {member.name}
                        </h4>
