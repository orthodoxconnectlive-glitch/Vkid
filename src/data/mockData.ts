...
export const MEDIA_LIBRARY: MediaItem[] = [
  // --- Math & Numbers ---
  {
    ...
    mediaUrl: 'https://www.youtube.com/embed/g2fA1S5mY58?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
  ...
  {
    id: 'm_math_2',
    title: 'Count Up to 100 with Fitness Fun',
    type: 'video',
    category: 'Math & Numbers',
    duration: '4:45',
    thumbnailUrl: 'https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/0TgLtF3PMOc?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5', '6-7'],
    description: 'Jump, stretch, and count to 100 by ones and tens with high-energy movement drills!',
    isPopular: true,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  {
    id: 'm_math_3',
    title: 'Addition & Subtraction Pizza Math',
    type: 'video',
    category: 'Math & Numbers',
    duration: '5:20',
    thumbnailUrl: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/IgBqa61wGBU?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
    description: 'Slice cheesy pizzas to solve simple addition and subtraction equations visually!',
    isPopular: false,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  },
  {
    ...
    mediaUrl: 'https://www.youtube.com/embed/q_yUC1NCFkE?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
    description: 'Catchy math song helping young learners master multiplication foundations.',
    isPopular: true,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  {
    id: 'm_math_5',
    title: '3D Geometric Shapes Explorer',
    type: 'video',
    category: 'Math & Numbers',
    duration: '4:15',
    thumbnailUrl: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/2cg-Uc556-Q?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5', '6-7'],
    description: 'Discover spheres, cubes, cylinders, and pyramids in everyday real-world objects.',
    isPopular: false,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  // --- Science & Discovery ---
  {
    ...
    mediaUrl: 'https://www.youtube.com/embed/libKVRa07fU?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
  ...
  {
    id: 'm_sci_2',
    title: 'Volcanoes & Lava Science Lab',
    type: 'video',
    category: 'Science & Discovery',
    duration: '6:10',
    thumbnailUrl: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/lAmqsMQG3RM?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
    description: 'Watch bubbly chemical reactions and learn how magma erupts into liquid lava!',
    isPopular: true,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  {
    id: 'm_sci_3',
    title: 'Caterpillars to Butterflies Metamorphosis',
    type: 'video',
    category: 'Science & Discovery',
    duration: '5:05',
    thumbnailUrl: 'https://images.unsplash.com/photo-1526336024174-e58f5cdd8e13?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/kVm5k99PnBk?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5', '6-7'],
    description: 'Follow hungry caterpillars building chrysalises and transforming into monarch butterflies!',
    isPopular: false,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  {
    id: 'm_sci_4',
    title: 'Why Does It Rain? Water Cycle for Kids',
    type: 'video',
    category: 'Science & Discovery',
    duration: '4:30',
    thumbnailUrl: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/ncORPosDrjE?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
    description: 'Understand evaporation, condensation, and precipitation in animated cloud stories.',
    isPopular: true,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  },
  {
    ...
    mediaUrl: 'https://www.youtube.com/embed/v8x10M1pMFA?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
  ...
  {
    id: 'm_mus_1',
    title: 'Freeze Dance & Action Songs for Kids',
    type: 'rhyme',
    ...
    mediaUrl: 'https://www.youtube.com/embed/2UcZWXvgMZE?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5', '6-7'],
    description: 'Dance, spin, jump, and freeze when the music stops! Great for motor skills.',
    isPopular: true,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  {
    id: 'm_mus_2',
    title: 'Boom Chicka Boom Dance Workout',
    type: 'rhyme',
    category: 'Music & Movement',
    duration: '4:00',
    thumbnailUrl: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/1gUbdNbu6ak?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5', '6-7'],
    description: 'Repeat-after-me call and response echo song full of cheerful dance moves!',
    isPopular: false,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  {
    id: 'm_mus_3',
    title: 'Clap Your Hands & Stomp Your Feet Rhyme',
    type: 'rhyme',
    category: 'Music & Movement',
    duration: '3:25',
    thumbnailUrl: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/f3P834Cj4E8?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5'],
    description: 'Classic rhythm exercise for toddlers and preschoolers to practice coordination.',
    isPopular: true,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  {
    id: 'm_mus_4',
    title: 'Little Symphony Orchestra & Instruments',
    type: 'video',
    category: 'Music & Movement',
    duration: '6:40',
    thumbnailUrl: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/mPhK1vIeX_s?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
    description: 'Hear violins, trumpets, flutes, and drums as the animal orchestra plays classical hits.',
    isPopular: false,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  // --- Storytime & Reading ---
  {
    ...
    type: 'rhyme',
    category: 'Storytime & Reading',
    duration: '4:10',
    thumbnailUrl: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/BELlZKpi1Zs?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5'],
  ...
  {
    id: 'm_read_1',
    title: 'The Brave Little Dinosaur Storytime',
    type: 'audiobook',
    category: 'Storytime & Reading',
    duration: '7:30',
    thumbnailUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/V6XfC0-I_sA?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5', '6-7'],
    description: 'Animated read-along story teaching kindness, resilience, and making new friends.',
    isPopular: true,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  // --- Arts & Crafts ---
  {
    ...
    mediaUrl: 'https://www.youtube.com/embed/4S24m98CjO8?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
  ...
  {
    id: 'm_art_2',
    title: 'How to Draw a Cartoon Rocket Ship',
    type: 'video',
    category: 'Arts & Crafts',
    duration: '6:00',
    thumbnailUrl: 'https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?auto=format&fit=crop&w=600&q=80',
    mediaUrl: 'https://www.youtube.com/embed/Rk1k8A6RThs?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['6-7', '8-10'],
    description: 'Follow simple pencil lines to draw cosmic rocket ships and alien pilots.',
    isPopular: false,
    status: 'approved',
    uploadedBy: 'curator@vkid.app',
    provider: 'youtube',
  ...
  // --- Pending Approval User Submissions (For Admin Moderation Queue) ---
  {
    ...
    mediaUrl: 'https://www.youtube.com/embed/2M-sFAt6qWk?autoplay=1&rel=0&modestbranding=1&controls=1&disablekb=1',
    targetAgeGroup: ['4-5', '6-7'],
