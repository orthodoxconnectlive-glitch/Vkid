...
export const NotificationDropdown: React.FC<NotificationDropdownProps> = ({
  ...
  return (
    <div className="absolute right-0 top-12 w-80 sm:w-96 bg-[#fdfaf5] border border-[#d4af37]/30 rounded-2xl shadow-2xl z-50 overflow-hidden animate-fadeIn">
      {/* Header */}
          ...
          notifications.slice(0, 6).map((notif) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="text-[9px] text-[#8b6b4a] block mt-1">
