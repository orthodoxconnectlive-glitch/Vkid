...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { id: 'messages', label: t('messages'), icon: MessageSquare, color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-100 dark:bg-emerald-900/30', count: unreadMessagesCount },
    { id: 'notifications', label: t('notifications'), icon: Bell, color: 'text-yellow-600 dark:text-yellow-400', bg: 'bg-yellow-100 dark:bg-yellow-900/30' },
  ...
  return (
    <aside className="hidden lg:block lg:w-64 shrink-0 space-y-4">
      ...
      <div className="bg-[#f6ebd6] dark:bg-[#1c1611] border-2 border-[#c5a059] dark:border-[#8b6b4a] rounded-3xl p-3.5 shadow-lg">
        ...
        {profile && (
          <button
            ...
            className="w-full flex items-center gap-3 p-2.5 rounded-2xl bg-[#eedcb5] dark:bg-[#282019] hover:bg-[#e6d3ab] transition-all text-left mb-3 group cursor-pointer border border-[#c5a059] dark:border-[#8b6b4a]"
          >
            <img
      ...
      <div className="bg-[#f6ebd6] dark:bg-[#1c1611] border-2 border-[#c5a059] dark:border-[#8b6b4a] rounded-3xl p-3 shadow-lg flex items-center justify-between text-xs">
        <div className="flex items-center gap-1">
          <button
            onClick={() => setLanguage('en')}
            className={`px-2.5 py-1 text-[10px] font-bold rounded-xl transition-colors cursor-pointer ${
              language === 'en' ? 'bg-[#c5a059] text-white' : 'text-[#7c5f3d] hover:text-[#3d2b18]'
            }`}
          >
            EN
          </button>
          <button
            ...
            className={`px-2.5 py-1 text-[10px] font-bold rounded-xl transition-colors cursor-pointer ${
              language === 'ar' ? 'bg-[#c5a059] text-white' : 'text-[#7c5f3d] hover:text-[#3d2b18]'
            }`}
          >
            عربي
          </button>
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`p-1.5 rounded-xl transition-colors cursor-pointer ${
              theme === 'ancient' ? 'bg-[#c5a059] text-white' : 'text-[#7c5f3d] hover:text-[#3d2b18]'
            }`}
            title={t('ancientGold')}
          >
          ...
          <button
            ...
            className={`p-1.5 rounded-xl transition-colors cursor-pointer ${
              theme === 'dark' ? 'bg-[#c5a059] text-white' : 'text-[#7c5f3d] hover:text-[#3d2b18]'
            }`}
            title={t('dark')}
          >
          ...
          <button
            ...
            className={`p-1.5 rounded-xl transition-colors cursor-pointer ${
              theme === 'light' ? 'bg-[#c5a059] text-white' : 'text-[#7c5f3d] hover:text-[#3d2b18]'
            }`}
            title={t('light')}
          >
